# from clocks/main
# @s: entity
execute as @s[type=#abgrund:condemnable,tag=!abg.condemned,predicate=!abgrund:biome/boosted_condemned_chance] if predicate uthi:rng/0.03 run function abgrund:entity/condemned/spawn
