...
tellraw @a[tag=uthi.dev] ["",{"score": {"name": "%limbo_creature","objective": "abg.mob_caps"}}," \"creature\" mobs currently loaded in Limbo"]
...
tellraw @a[tag=uthi.dev] ["",{"score": {"name": "%jardin_creature","objective": "abg.mob_caps"}}," \"jardin creature\" mobs currently loaded in Limbo"]
